...
`smoken`. The following is my model:
...
![](p8105_hw6_kzw2102_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->
...
![](p8105_hw6_kzw2102_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
...
used to produce estimates of the \(r^2\) value and of
\(log{(\hat{\beta}_0^2*\hat{\beta}_1^2)}\) In our model, \(r^2\) , we
are 95% confident that our true \(r^2\) value lies between 0.8936684 and
0.927106. Also, we are 95% confident that the true $ log(\_0^2\*\_1^2)$
lies between 1.9649487 and 2.0588875. As seen here, our \(r^2\)
distributions has a right skewed distribution. However, our $
log(\_0^2\*\_1^2)$ distribution looks more normal, which would make
sense as we usually use the log transformation to make skewed
